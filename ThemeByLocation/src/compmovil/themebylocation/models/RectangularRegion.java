...
//	static double MAX_DISTANCE = 1/3600 * 33;
	...
	public RectangularRegion(int id, Location corner0, Location corner1) throws Exception{
...
//			throw new Exception("La región debe ser al menos 1km por al menos 1km");
		...
		Log.i("THEMELOCATION", "SW: (" + mSouthMostLatitude + ", " + mWestMostLongitude + ")   NE: (" + mNorthMostLatitude + ", " + mEastMostLongitude + ")" );
